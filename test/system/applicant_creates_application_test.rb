...
class ApplicantCreatesApplicationTest < ApplicationSystemTestCase
  ...
  test 'applicant creates their application' do
    ...
    fill_in 'Total Monthly Income', with: '100'
    fill_in 'Total Monthly from Scholarships/Grants', with: '100'
    fill_in 'Tuition', with: '100'
    fill_in 'application[supplies]', with: '100'
    fill_in 'application[childcare]', with: '100'
    fill_in 'application[transportation]', with: '100'
    fill_in 'application[other]', with: '100'
    fill_in 'application[monthly_expenses]', with: '100'
    fill_in 'application[savings]', with: '100'
    fill_in 'application[investments]', with: '100'
    fill_in 'application[school_loan_debt]', with: '100'
    fill_in 'application[other_debt]', with: '100'
